...
add('enablement.filter.costMax', 'Max direct cost (USD)', 'Custo direto máx. (USD)', 'Costo directo máx. (USD)');
add('enablement.filter.timeMax', 'Max time (hours)', 'Tempo máx. (horas)', 'Tiempo máx. (horas)');
