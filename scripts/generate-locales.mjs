...
add('nav.enablement', 'Enablement Matrix', 'Matriz de enablement', 'Matriz de enablement');
...
add('home.cardEnablementTitle', 'Enablement Matrix', 'Matriz de certificação e acreditação', 'Matriz de certificación y acreditación');
add('home.cardEnablementDesc', 'Plan certification and partner accreditation paths with time, cost, and prerequisite maps.', 'Planeje percursos de certificação e acreditação com tempo, custo e mapas de pré-requisitos.', 'Planifique rutas de certificación y acreditación con tiempo, costo y mapas de requisitos previos.');
add('home.cardEnablementCta', 'Open matrix', 'Abrir matriz', 'Abrir matriz');
...
add('home.eyebrow', 'Splunk Enterprise · On-premises', 'Splunk Enterprise · On-premises', 'Splunk Enterprise · On-premises');
...
// --- ENABLEMENT MATRIX ---
add('enablement.eyebrow', 'Splunk training & partner enablement', 'Formação Splunk e enablement de parceiros', 'Formación Splunk y enablement de partners');
add('enablement.title', 'Certification & Accreditation Matrix', 'Matriz de certificação e acreditação', 'Matriz de certificación y acreditación');
add('enablement.subtitle', 'Filter credentials, map prerequisites, and roll up time and cost for partner enablement planning.', 'Filtre credenciais, mapeie pré-requisitos e consolide tempo e custo para planeamento de enablement.', 'Filtre credenciales, mapee requisitos previos y consolide tiempo y costo para planificación de enablement.');
add('enablement.pathTitle', 'Select a credential', 'Selecione uma credencial', 'Seleccione una credencial');
add('enablement.selectPrompt', 'Select a certification or accreditation from the catalog to view its prerequisite path.', 'Selecione uma certificação ou acreditação no catálogo para ver o percurso de pré-requisitos.', 'Seleccione una certificación o acreditación del catálogo para ver la ruta de requisitos previos.');
add('enablement.partner', 'Partner', 'Parceiro', 'Partner');
add('enablement.legacy', 'Legacy', 'Legacy', 'Legacy');
add('enablement.yes', 'Yes', 'Sim', 'Sí');
add('enablement.markComplete', 'Mark complete', 'Marcar como concluído', 'Marcar como completado');
add('enablement.disclaimer', 'Time and cost estimates are indicative. Official Splunk pricing and accreditation requirements may change.', 'Estimativas de tempo e custo são indicativas. Preços e requisitos oficiais Splunk podem mudar.', 'Las estimaciones de tiempo y costo son orientativas. Los precios y requisitos oficiales de Splunk pueden cambiar.');
add('enablement.credlyNotice', 'Badge images © Splunk via Credly. Partner Mindtickle links may require partner login.', 'Imagens de badges © Splunk via Credly. Links Mindtickle de parceiro podem exigir login de parceiro.', 'Imágenes de badges © Splunk via Credly. Los enlaces Mindtickle de partner pueden requerir inicio de sesión de partner.');
add('enablement.filter.search', 'Search', 'Pesquisar', 'Buscar');
add('enablement.filter.searchPlaceholder', 'Filter by name or objective…', 'Filtrar por nome ou objetivo…', 'Filtrar por nombre u objetivo…');
add('enablement.filter.track', 'Track', 'Trilha', 'Ruta');
add('enablement.filter.persona', 'Persona', 'Persona', 'Persona');
add('enablement.filter.all', 'All', 'Todos', 'Todos');
add('enablement.filter.partnerOnly', 'Partner credentials only', 'Apenas credenciais de parceiro', 'Solo credenciales de partner');
add('enablement.filter.hideCompleted', 'Hide completed', 'Ocultar concluídos', 'Ocultar completados');
add('enablement.menuToggle', 'Open catalog filters', 'Abrir filtros do catálogo', 'Abrir filtros del catálogo');
add('enablement.notes.title', 'Partner & certification planning notes', 'Notas de planeamento para parceiros e certificação', 'Notas de planificación para partners y certificación');
add('enablement.notes.fastStart', 'Splunk Core Certified Power User Fast Start eLearning is free for Splunk partners (plan prep before the $130 USD exam).', 'O eLearning Fast Start do Splunk Core Certified Power User é gratuito para parceiros Splunk (planeie a preparação antes do exame de 130 USD).', 'El eLearning Fast Start de Splunk Core Certified Power User es gratuito para partners Splunk (planifique la preparación antes del examen de 130 USD).');
add('enablement.notes.partnerDiscount', 'Splunk Education ILT and eLearning list prices are typically 50% off for partners—use as a planning estimate; confirm quotes with your account team.', 'Os preços de lista ILT e eLearning da Splunk Education costumam ter 50% de desconto para parceiros—use como estimativa; confirme cotações com a sua equipa de conta.', 'Los precios de lista ILT y eLearning de Splunk Education suelen tener 50% de descuento para partners—úsalo como estimación; confirma cotizaciones con tu equipo de cuenta.');
add('enablement.notes.exam', 'Splunk certification exams are $130 USD via Pearson VUE; register about one week before your target date.', 'Os exames de certificação Splunk são 130 USD via Pearson VUE; registe-se cerca de uma semana antes da data pretendida.', 'Los exámenes de certificación Splunk son 130 USD vía Pearson VUE; regístrese unos siete días antes de la fecha objetivo.');
add('enablement.notes.coursesHint', 'Course list prices in the Courses tab do not include the partner 50% discount.', 'Os preços de lista na aba Cursos não incluem o desconto de 50% para parceiros.', 'Los precios de lista en la pestaña Cursos no incluyen el descuento del 50% para partners.');
add('enablement.pathTable.step', 'Step', 'Passo', 'Paso');
add('enablement.pathTable.credential', 'Credential', 'Credencial', 'Credencial');
add('enablement.pathTable.type', 'Type', 'Tipo', 'Tipo');
add('enablement.pathTable.time', 'Time', 'Tempo', 'Tiempo');
add('enablement.pathTable.cost', 'Cost', 'Custo', 'Costo');
add('enablement.pathTable.status', 'Status', 'Estado', 'Estado');
add('enablement.pathTable.links', 'Links', 'Links', 'Enlaces');
add('enablement.tab.accreditations', 'Accreditations', 'Acreditações', 'Acreditaciones');
add('enablement.tab.certifications', 'Certifications', 'Certificações', 'Certificaciones');
add('enablement.tab.badges', 'Badges', 'Badges', 'Badges');
add('enablement.tab.courses', 'Courses', 'Cursos', 'Cursos');
add('enablement.track.general', 'General', 'Geral', 'General');
add('enablement.track.observability', 'Observability', 'Observability', 'Observability');
add('enablement.track.security', 'Security', 'Security', 'Security');
add('enablement.track.core', 'Core / Platform', 'Core / Platform', 'Core / Platform');
add('enablement.kind.certification', 'Certification', 'Certificação', 'Certificación');
add('enablement.kind.accreditation', 'Accreditation', 'Acreditação', 'Acreditación');
add('enablement.kind.technical_badge', 'Technical badge', 'Badge técnico', 'Badge técnico');
add('enablement.kind.assessment', 'Assessment', 'Avaliação', 'Evaluación');
add('enablement.persona.sales', 'Sales', 'Vendas', 'Ventas');
add('enablement.persona.se', 'Sales Engineer', 'Sales Engineer', 'Sales Engineer');
add('enablement.persona.consultant', 'Consultant', 'Consultor', 'Consultor');
add('enablement.persona.admin', 'Admin', 'Admin', 'Admin');
add('enablement.persona.developer', 'Developer', 'Developer', 'Developer');
add('enablement.summary.time', 'Total time', 'Tempo total', 'Tiempo total');
add('enablement.summary.cost', 'Total cost', 'Custo total', 'Costo total');
add('enablement.summary.steps', 'Steps', 'Passos', 'Pasos');
add('enablement.summary.team', 'Team plan', 'Plano de equipa', 'Plan de equipo');
add('enablement.summary.updated', 'Data updated {date}', 'Dados atualizados {date}', 'Datos actualizados {date}');
add('enablement.orBranch.label', 'Complete one path', 'Conclua um percurso', 'Complete una ruta');
add('enablement.view.path', 'Path map', 'Mapa de percurso', 'Mapa de ruta');
add('enablement.view.matrix', 'Matrix table', 'Tabela matriz', 'Tabla matriz');
add('enablement.export.markdown', 'Copy path (Markdown)', 'Copiar percurso (Markdown)', 'Copiar ruta (Markdown)');
add('enablement.export.csv', 'Copy path (CSV)', 'Copiar percurso (CSV)', 'Copiar ruta (CSV)');
...
add('enablement.matrix.track', 'Track', 'Trilha', 'Ruta');
add('enablement.matrix.time', 'Time', 'Tempo', 'Tiempo');
add('enablement.matrix.cost', 'Cost', 'Custo', 'Costo');
add('enablement.matrix.prereqs', 'Prereq nodes', 'Nós pré-req.', 'Nodos prereq.');
add('enablement.matrix.partner', 'Partner', 'Parceiro', 'Partner');
add('enablement.callout.observability', 'Lab deploy for observability consultants:', 'Implantação de laboratório para consultores observability:', 'Implementación de laboratorio para consultores observability:');
add('enablement.callout.guideLink', 'Open Deployment Guide', 'Abrir guia de implantação', 'Abrir guía de implementación');
...
add('planner.field.manualHardwareSpec', 'Manual hardware specification', 'Especificação manual de hardware', 'Especificación manual de hardware');
add('planner.field.manualHardwareHint', 'Overrides replace automatic 10.4 hardware baselines for selected components.', 'As substituições substituem as baselines automáticas 10.4 para os componentes selecionados.', 'Las sustituciones reemplazan las baselines automáticas 10.4 para los componentes seleccionados.');
add('planner.field.indexerHardwareTier', 'Indexer hardware tier', 'Tier de hardware do indexer', 'Nivel de hardware del indexer');
add('planner.field.indexerHardwareTierCombined', 'Combined instance hardware tier', 'Tier de hardware da instância combinada', 'Nivel de hardware de la instancia combinada');
add('planner.field.indexerTierMin', 'Minimum (10.4)', 'Mínimo (10.4)', 'Mínimo (10.4)');
add('planner.field.indexerTierMid', 'Mid-range (10.4)', 'Médio (10.4)', 'Intermedio (10.4)');
add('planner.field.indexerTierHigh', 'High-performance (10.4)', 'Alto desempenho (10.4)', 'Alto rendimiento (10.4)');
add('planner.field.indexerTierCustom', 'Custom', 'Personalizado', 'Personalizado');
add('planner.field.hwPhysicalCores', 'Physical cores', 'Núcleos físicos', 'Núcleos físicos');
add('planner.field.hwVcpu', 'vCPU', 'vCPU', 'vCPU');
add('planner.field.hwRamGb', 'RAM (GB)', 'RAM (GB)', 'RAM (GB)');
add('planner.field.hwOsDiskGb', 'OS disk (GB)', 'Disco OS (GB)', 'Disco OS (GB)');
add('planner.field.hwSplunkDiskGb', 'Splunk / data disk (GB)', 'Disco Splunk / dados (GB)', 'Disco Splunk / datos (GB)');
add('planner.hwRole.searchHead', 'Search head (operational)', 'Search head (operacional)', 'Search head (operacional)');
add('planner.hwRole.searchHeadEs', 'Enterprise Security search head', 'Search head Enterprise Security', 'Search head Enterprise Security');
add('planner.hwRole.searchHeadItsi', 'ITSI search head', 'Search head ITSI', 'Search head ITSI');
add('planner.hwRole.clusterManager', 'Cluster Manager', 'Cluster Manager', 'Cluster Manager');
add('planner.hwRole.deploymentServer', 'Deployment Server', 'Deployment Server', 'Deployment Server');
add('planner.hwRole.shcDeployer', 'SHC Deployer', 'SHC Deployer', 'SHC Deployer');
add('planner.hwRole.licenseManager', 'License Manager', 'License Manager', 'License Manager');
add('planner.hwRole.monitoringConsole', 'Monitoring Console', 'Monitoring Console', 'Monitoring Console');
add('planner.hwRole.managementStack', 'Colocated management stack', 'Stack de gestão colocado', 'Stack de gestión colocado');
